...
//xferDir(0,'www','');
 xferDir('top','','server');
xferFiles(0,'www',['page.html','altPage.html','draw.html','drawImage.html','essay.html','eutelic.html','zoom0.js','topdefs.js','style.css','spectrum.css']);
//xferDir(1,'www','doc');
//xferDir(0,'www','intro');
//xferDir(1,'shell','');
...
xferDirs(0,'none',['gen0','ngen1','final','mlib','line','shape']); 
