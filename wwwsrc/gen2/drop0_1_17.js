...
rs.setName('drop0_1_17');
let ht = 300;
let wd = 1.5 * ht;
//wd = ht; //for instagram
let topParams = {width:wd,height:ht,numSeedRows:4,numSeedCols:4,onlyFromSeeds:0,maxDrops:10000,maxTries:100,lineLength:10,backgroundColor:'rgb(2,2,2)',backgroundPadding:10,minSeparation:0,rectangleDim:0.5,gridPadding:60}
