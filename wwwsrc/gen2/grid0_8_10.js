...
let topParams = {randomizeOrder:1,orderByOrdinal:1,width:300,height:300,pointJiggle:0,backgroundColor:'black',numRows:64,numCols:64};
 //topParams = {randomizeOrder:0,orderByOrdinal:1,width:300,height:300,pointJiggle:0,backgroundColor:'black',numRows:30,numCols:30};
...
grid1.globalParams = globalParams0;
...
const setPbr= function (is1,pbr) {
	let nr = is1?grid1.numRows:grid0.numRows;
	let nrh = 0.5* nr;
