...
rs.setName('drop0_1_26');
let ht = 1600;
let topParams = {width:ht,height:ht,numRows:20,numCols:30,maxDrops:15000,maxTries:10,endLoopss:1000,lineLength:10,backgroundColor:'rgb(2,2,2)',backgroundPadding:0.1*ht,separation:0,randomDirectionChange:0.2*Math.PI,fromEnds:1,sepNext:.1,lineExt:.2,onlyFromSeeds:1,extendWhich:'random',numSeeds:3,splitChance:0.5,splitAmount:0.08 * Math.PI,directionChange:0.025 * Math.PI}
