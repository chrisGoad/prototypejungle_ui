...
rs.setName('drop0_0_10');
let ht = 400;
let topParams = {width:1.0*ht,height:ht,maxDrops:50000,maxTries:100,lineLength:2,backgroundColor:'rgba(2,2,2)',minSeparation:0,backgroundPadding:0.1*ht}
