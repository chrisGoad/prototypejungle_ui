...
rs.samples = ['fx-01','fx-02','hh-01','hh-02','ir-hall','kd-01',
...
const mkTune1 = function (gains) {
 // debugger;
  let numNotes = 5;
 // let tune = rs.mkBlankTune(numNotes,0,noteDur*numNotes,'perc-02');
  let evr = rs.mkEvenRhythm(numNotes,1);
 // let gains = [2,0.05,0.5,0.0,0.05];
  let tn = rs.mkAtune({insts:'hh-01',rhythm:evr,gains:gains,duration:numNotes,detunes:-1500});
  return tn;
}
const mkTune2 = function () {
  debugger;
  let tn0 = mkTune1([2,0.2,0.001,0.2,0.2]);
  let rtn0 = tn0.repeat(2);
//  debugger;
 //return rtn0;
  //let rtn0 = tn0.repeat(2);
  let tn1 = mkTune1([2,0.05,0.05,0.5,0.001]);
