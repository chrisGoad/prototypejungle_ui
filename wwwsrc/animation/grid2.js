...
item.updateForTime = function (tm) {
  ...
  if (tm < 1) {
    ...
    let fr = (tm - 2)/1;
    let w = interpolate(this.initWidth,this.finalWidth,fr);
     let h = interpolate(this.initHeight,this.finalHeight,fr);
   this.grid.elementP.width = Math.max(7,w);//d;
    this.grid.elementP.height = h;
    this.grid.elementP.fill = 'rgba(200,200,200,.2)';
...
item.initialize = function () {
  ...
  //this.grid.elementP.extraLeft = 0;
  //this.grid.elementP.extraRight = 0;
