...
rs.setName('drop0_0');
let wd = 200;
let topParams = {width:wd,height:wd,maxDrops:10000,dropTries:100,lineLength:2,backStripeColor:'rgb(2,2,2)',backStripePadding:20,backStripeVisible:0,minSeparation:10}
