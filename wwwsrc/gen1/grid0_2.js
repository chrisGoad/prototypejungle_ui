...
//	let pdir = dirValues?dirValues[idx]:this.computeDirValues();
	let cdir = dirValues?dirValues[idx]:this.computeDirValue(x,y);
	
	let pdir = this.patternDir?this.patternDir(x,y):null;
	let dir = (typeof pdir === 'number')?pdir:cdir;
  this.setLineEnds(line0,lineLength,dir);
	if (pdir && this.patternOp) {
