...
const genRandom = function (itm) {
   let rnd0 = itm.width * (itm.randomFactor * (Math.random()-0.5));
   let rnd1 = itm.width * (itm.randomFactor * (Math.random()-0.5));
...
item.update = function () {
  ...
  let lowerRight = Point.mk(hw,hh).plus(genRandom(this));
  let upperLeft = Point.mk(-hw,-hh).plus(genRandom(this))
  let upperRight = Point.mk(hw,-hh).plus(genRandom(this))
  let lowerLeft = Point.mk(-hw,hh).plus(genRandom(this))
  ...
  if (0 && (this.extraRight === 0) && (this.extraLeft === 0)) {
