...
item.update = function () {
  if (!this.shaft) {
    ...
    //this.shaft.neverselectable = true; //9/13
    this.shaft.text = '';
...
item.installShaft = function (line) {
  core.assignPrototype(this,'lineP',line);
}

ui.hide(item,['end0','end1','text','textItem','shaft','shaftProperties']);
