...
if (radial) {
  ...
  topParams = {numRows:nr,numCols:nr,width:wd,height:ht,backStripeColor:'rgb(2,2,2)',pointJiggle:0,backStripePadding:0.15*wd,sideA:function(fr) {return this.leftSide.pointAlong(fr)},sideB:function(fr) {return this.rightSide.pointAlong(fr)},positionFunction:grid1.sidesPositionFunction};
}
