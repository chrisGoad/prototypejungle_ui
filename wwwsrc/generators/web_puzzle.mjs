...
//core.require('/gen0/min0.js','/shape/circle.js','/line/line.js','/mlib/pgen0.js','/mlib/webTree.js','/mlib/web0.js',function (addBasis,circlePP,linePP,addPointGenMethodsaddWebTreeMethods,addWebMethods) {
...
let  topParams = {backgroundColor:'rgb(2,2,2)',backgroundPadding:0.1*ht,width:ht,height:ht,webTries:100,maxFringeTries:100,numRings:nrc,numRows:nrc,numCols:nrc,minConnectorLength:mcl,maxConnectorLength:mcl+minc,numPairs:2,fringeColor:'blue',missingCols:1,missingRows:1,jiggle:0.0*cellsz};
let source, target;
