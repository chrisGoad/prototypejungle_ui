...
item.initialize = function () {
  ...
  this.addQuadLines(this.lineP,lines,quad1,this.numLines,this.maxThere,this.minThere,this.maxMissing,this.minMissing,minSep)
  this.addQuadLines(this.lineP,lines,quad2,this.numLines,this.maxThere,this.minThere,this.maxMissing,this.minMissing,minSep)
}	
return item;
});
