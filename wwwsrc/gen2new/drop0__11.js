...
addDropMethods(rs);
rs.setName('drop0__11');
let ht =400;
let topParams = {width:1.5*ht,height:ht,maxDrops:100000,maxTries:100,lineLength:2,backgroundColor:'rgb(2,2,2)',backgroundPadding :0.1*ht,minSeparation:0}
