...
item.set('end0',geom.Point.mk(-250,0));
item.set('end1',geom.Point.mk(250,0));
...
item.update = function () {
  ...
  //maybe the prototype has been changed for this spots,
  if (shownSpots > 0) {
    let proto = Object.getPrototypeOf(this);
    spotP = Object.getPrototypeOf(this.s0);
    proto.spotP = spotP;
  }
  let spotPP = Object.getPrototypeOf(spotP);
  //spotPP.dimension = this['stroke-width'];
  spotPP.fill =  this.stroke;
