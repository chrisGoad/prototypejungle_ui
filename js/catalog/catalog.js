...
const loadSvg = function (element) {
  if ((element.svg) && (!element.svgLoaded)) {
    //console.log('loading svg for ',element.id);
    element.svgLoaded = true;
    let img = element.img_of;
    core.vars.mapUrl(element.svg,function (iurl) {img.src = iurl;});
...
export {extensionCatalog,show,getAndShow,tabSelectCallbacks,selectTab,highlightElement,showCurrentTab,
